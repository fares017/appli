...
class ProductsTableseeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Product::create([
            ...
            "title" => [
                'en' => 'Graphics card Asus GTX1650 4GB TUF Gaming O4GD6',
                'fr' => 'Cartes Graphiques Asus GTX1650 4GB TUF Gaming O4GD6'
                  ],
                        
            "slug" => "cartes-graphiques-asus-gtx1650-4gb-tuf-gaming-o4gd6",
            "subtitle" => "cartes-graphiques-asus-gtx1650-4gb-tuf-gaming-o4gd6",
            "description" => [
                'en' => 'NVIDIA GeForce GTX 1650 graphics card
                        with base clock / boost 1410/1680 MHz
                        GDDR6-VRAM 4 GB with 12 GHz RAM clock (effective)
                        compact two-fan cooler design ',
                'fr' => 'Carte graphique NVIDIA GeForce GTX 1650
...
//             "title" =>   ['en' => 'Graphics card Asus GTX1650 4GB TUF Gaming O4GD6',
//             'fr' => 'Cartes Graphiques Asus GTX1650 4GB TUF Gaming O4GD6'],
