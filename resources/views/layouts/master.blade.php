...
<html lang="en">
	<head>
		...
		<!-- Bootstrap -->
		<link type="text/css" rel="stylesheet" href="{{ URL::secure_asset('css/bootstrap.min.css') }}" />

		<!-- Slick -->
		<link type="text/css" rel="stylesheet" href="{{ URL::secure_asset('css/slick.css') }}"  />
		<link type="text/css" rel="stylesheet" href="{{ URL::secure_asset('css/slick-theme.css') }}"  />

		<!-- nouislider -->
		<link type="text/css" rel="stylesheet"  href="{{ URL::secure_asset('css/nouislider.min.css') }}"  />

		<!-- Font Awesome Icon -->
		<link rel="stylesheet" href="{{ URL::secure_asset('css/font-awesome.min.css') }}"   >

		<!-- Custom stlylesheet -->
		<link type="text/css" rel="stylesheet"  href="{{ URL::secure_asset('css/style.css') }}"   />
   ...
   {{-- <!-- Fixed navbar -->
	  ...
	  @yield('content')
		...
		<script type="text/javascript" src="{{ URL::secure_asset('js/nouislider.min.js') }}"></script>
		<script type="text/javascript" src="{{ URL::secure_asset('js/jquery.zoom.min.js') }}"></script>
		<script type="text/javascript" src="{{ URL::secure_asset('js/main.js') }}"></script>
