...
<html lang="en">
	<head>
		...
		<!-- Slick -->
		<link type="text/css" rel="stylesheet" href="{{ secure_asset('css/slick.css') }}"  />
		<link type="text/css" rel="stylesheet" href="{{ secure_asset('css/slick-theme.css') }}"  />

		<!-- nouislider -->
		<link type="text/css" rel="stylesheet"  href="{{ secure_asset('css/nouislider.min.css') }}"  />
   ...
   {{-- <!-- Fixed navbar -->
	  ...
	  @yield('content')
		...
		<script type="text/javascript" src="{{ secure_asset('js/nouislider.min.js') }}"></script>
		<script type="text/javascript" src="{{ secure_asset('js/jquery.zoom.min.js') }}"></script>
